...
9. [`Rabbitmq`](install_k8s/rabbitmq/)
10. [`CloudShell`](install_k8s/cloud-shell/README.md)
11. [`Controller`](install_k8s/gok-agent/README.md)
12. [`Che`](install_k8s/eclipseche/README.md)
13. [`JupyterHub`](install_k8s/jupyter/README.md)
14. [`Kubernetes Dashboard`](install_k8s/dashboard/README.md)
15. [`Spinnaker`](install_k8s/spinnaker/README.md)
16. [`Jenkins`](install_k8s/jenkins)
17. [`Istio`](install_k8s/istio/README.md)
18. [`Opensearch`](install_k8s/opensearch/README.md)
19. [`Prometheus-Grafana`](install_k8s/prometheus-grafana/README.md)
20. [`Fluentd`](install_k8s/fluentd/README.md)
21. [`Kube Login Webhook`](https://github.com/sumitmaji/kubernetes/tree/master/install_k8s/kube-login)
22. [`Devops`](https://github.com/sumitmaji/kubernetes/blob/master/install_k8s/setUp-Devops.sh): [`Githook`](https://github.com/sumitmaji/kubernetes/tree/master/install_k8s/githook), [`Dockerhook`](https://github.com/sumitmaji/kubernetes/tree/master/install_k8s/dockerhook), [`Reghook`](https://github.com/sumitmaji/kubernetes/tree/master/install_k8s/reghook)
23. [`Kube Authentication`](https://github.com/sumitmaji/kubeauthentication)
24. [`Ldap`](https://github.com/sumitmaji/kubernetes/blob/master/install_k8s/ldap/run_ldap.sh): [`Link`](https://github.com/sumitmaji/kubernetes/tree/master/install_k8s/ldap)
25. [`Kerberos`](https://github.com/sumitmaji/kubernetes/blob/master/install_k8s/kerberos/run_kerberos.sh): [`Link`](https://github.com/sumitmaji/kubernetes/tree/master/install_k8s/kerberos)
26. [`Ldap Client`](https://github.com/sumitmaji/kubernetes/blob/master/install_k8s/ldapclient/run_ldapclient.sh): [`Link`](https://github.com/sumitmaji/kubernetes/tree/master/install_k8s/ldapclient1)
27. [`Ldap Client2`](https://github.com/sumitmaji/kubernetes/blob/master/install_k8s/ldapclient2/run_ldapclient2.sh): [`Link`](https://github.com/sumitmaji/kubernetes/tree/master/install_k8s/ldapclient2)
