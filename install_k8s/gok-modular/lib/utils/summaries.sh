...
show_oauth2_summary() {
  ...
  echo -e "  🏢 ${COLOR_CYAN}Identity Provider${COLOR_RESET}: keycloak.gokcloud.com"
  echo -e "  🌍 ${COLOR_CYAN}Keycloak Realm${COLOR_RESET}: GokDevelopers"
